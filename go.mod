...
// Use the pushed perf/complete-optimizations fork head until these commits land upstream.
replace github.com/daeuniverse/outbound => github.com/olicesx/outbound v0.0.0-sticky-ip.0.20260415045205-3d0f2cc78975
