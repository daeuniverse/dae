...
// The following BPF types are auto-generated by bpf2go in bpf_bpfel.go:
// - bpfTuplesKey (corresponds to struct tuples_key in tproxy.c, used as key for RoutingTuplesMap)
// - bpfRoutingResult (corresponds to struct routing_result in tproxy.c, value type from RoutingTuplesMap)
// - bpfDomainRouting (corresponds to struct domain_routing in tproxy.c, stores domain routing bitmap)
